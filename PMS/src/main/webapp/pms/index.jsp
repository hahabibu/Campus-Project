        ...
        <div class="navbar-header pull-right" role="navigation">
            <ul class="nav ace-nav">
                ...
                <li class="light-blue"><a data-toggle="dropdown" href="#"
                        ...
                        class="user-info"> <small>欢迎光临,hahabibu</small>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <ul class="nav nav-list">
                ...
                <li><a href="javascript:void(0)" target="mainframe"
                    ...
                    <ul class="submenu">
                        <li><a href="pms/system/roleinfo/roleinfo_list.html" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 角色管理
                        </a></li>
                        <li><a href="pms/system/roleinfo/staffinfo_role_list.html" target="mainframe"> <i
                        ...
                        <li><a href="pms/system/datadictionary/datadictionary_list.html" target="mainframe"> <i
                ...
                <li><a href="javascript:void(0)" target="mainframe"
                    ...
                    <ul class="submenu">
                        <li><a href="pms/user/userinfo/user_list.html" target="mainframe"> <i
                ...
                <li><a href="javascript:void(0)" target="mainframe"
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="pms/recruitstudent/studentpool/studentpool_list.html" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 申报入口
                        </a></li>
                        <li><a href="pms/recruitstudent/recruitstudent/recruitstudent_list.html" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 申报材料
                        </a></li>
                        <li><a href="pms/recruitstudent/trackrecord/trackrecord_list.html" target="mainframe"> <i
                ...
                <li><a href="javascript:void(0)" target="mainframe"
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="pms/classinfo/disciplineinfo/disciplineinfo_list.html" target="mainframe"> <i
                                class="icon-double-angle-right"></i> 中期检查管理
                        </a></li>
                        <li><a href="pms/classinfo/classroominfo/classroominfo_list.html" target="mainframe"> <i
