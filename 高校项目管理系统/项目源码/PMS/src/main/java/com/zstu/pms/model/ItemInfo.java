...
public class ItemInfo {
	...
	public String toString() {
		return "ItemInfo [itemId=" + itemId + ", itemName=" + itemName + ", itemClass=" + itemClass + ", principal="
				+ principal + ", phone=" + phone + ", email=" + email + ", profession=" + profession + ", members="
				+ members + ", commitment=" + commitment + ", annex=" + annex + ", delTag=" + delTag + "]";
	}
