...
//            LOGGER.debug("计时结束："+ new SimpleDateFormat("hh:mm:ss.SSS").format(endTime) + " 耗时：" + DateUtils.formatDateTime(endTime - beginTime) + " URI:" +
           /* LOGGER.debug("计时结束："+ new SimpleDateFormat("hh:mm:ss.SSS").format(endTime) + " 耗时：" + (endTime - beginTime) + " URI:" +
           ...
           */ 
            LOGGER.debug("计时结束："+ new SimpleDateFormat("hh:mm:ss.SSS").format(endTime) + "\n" 
