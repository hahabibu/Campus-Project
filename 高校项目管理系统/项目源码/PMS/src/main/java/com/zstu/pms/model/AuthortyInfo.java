...
public class AuthortyInfo {
    ...
    public String getAuthortyClass() {
        return authortyClass;
    }

    public void setAuthortyClass(String authortyClass) {
        this.authortyClass = authortyClass == null ? null : authortyClass.trim();
    }
}